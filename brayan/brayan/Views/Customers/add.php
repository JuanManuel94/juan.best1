            ...
            <li>
                <a href="#step-1">
                    ...
                    <span class="info">
                        ...
                        <small>Nombres,apellidos,dni,ruc,etc.</small>
                    </span>
                </a>
            </li>
            <li>
                ...
                <fieldset>
                    <div class="row">
                        <div class="col-xl-8 offset-xl-2">
                            ...
                            <div class="form-group row m-b-10">
                            <label class="col-md-3 text-lg-right col-form-label">Dirección <span
                            class="text-danger">*</span></label>
                                <div class="col-md-9">
                            ...
                            <div class="panel panel-default" data-sortable="false">
                                ...
                                <div class="panel-body border-panel">
                                    ...
                                    <div class="form-group row m-b-10 cont-day">
                                        <label class="col-md-5 text-lg-right col-form-label">Modalidad</label>
                                        <div class="col-md-6">
